			...
			<div class="card">
				...
				<Toolbar class="mb-0">
					...
					<template v-slot:end>
						...
						<div class="p-inputgroup">
							...
							<InputText placeholder="PV name" style="width: 20em" v-model="inputPVName" v-on:keyup.enter="getPVInfo(inputPVName)" />
							<Button label="Info" icon="pi pi-play-circle" severity="success" style="width: 80px" @click="getPVInfo(inputPVName)" />
						</div>
					</template>
				</Toolbar>
				...
				<table width="100%" style="border-collapse: collapse; margin-bottom: 4em; margin-top: 4em;">
					...
					<tr height="40em">
						...
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.units }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Description</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.description }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Precision</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.precision }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Min</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.min }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Max</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.max }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Warning Low</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.warn_low }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Warning high</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.warn_high }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Alarm low</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.alarm_low }}</span></td>
					</tr>
					<tr height="40em">
						<td colspan="1" align="left" style="width: 30%"><span style="margin-left: 0.5em;">Alarm high</span></td>
						<td colspan="3" align="left"><span style="margin-left: 0.5em;">{{ pvData.alarm_high }}</span></td>
					</tr>
				</table>
			</div>
		</div>
	...
	methods: {
		...
		async getPVInfo(pvname) {
            ...
            try {
				...
				this.pvData.units = pv.units;
				this.pvData.description = pv.description;
				this.pvData.precision = pv.precision;
				this.pvData.min = pv.min;
				this.pvData.max = pv.max;
				this.pvData.warn_low = pv.warn_low;
				this.pvData.warn_high = pv.warn_high;
				this.pvData.alarm_low = pv.alarm_low;
				this.pvData.alarm_high = pv.alarm_high;
			} catch(error) {
				if(error.response) {
